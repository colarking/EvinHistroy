...
public class CalendarDatePickerDialogFragment extends DialogFragment implements OnClickListener, CalendarDatePickerController, YearChooseLayout.YearClickListener {
    ...
    public interface OnDateSetListener {
         ...
         */
        void onDateSet(CalendarDatePickerDialogFragment dialog, int ADorBC,int year, int monthOfYear, int dayOfMonth);
    }
    ...
    public CalendarDatePickerDialogFragment setPreselectedDate(int ADorBC,int year, int monthOfYear, int dayOfMonth) {
        mCalendar.set(Calendar.YEAR, year);
        mCalendar.set(Calendar.MONTH, monthOfYear);
        mCalendar.set(Calendar.DAY_OF_MONTH, dayOfMonth);
        this.ADorBC = ADorBC;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        doneButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                tryVibrate();
                if (mCallBack != null) {
                    mCalendar.set(Calendar.YEAR,mYearView2.getYear());
                    mCallBack.onDateSet(CalendarDatePickerDialogFragment.this, mCalendar.get(Calendar.ERA),mCalendar.get(Calendar.YEAR),
    ...
    public void yearClick() {
        ...
        CalendarDay minDay = new CalendarDay((year - 20) >0?(year-20):1, Calendar.JANUARY, 1);
        CalendarDay maxDay = new CalendarDay((year + 20) > 9999?9999:(year+20), Calendar.DECEMBER, 31);
