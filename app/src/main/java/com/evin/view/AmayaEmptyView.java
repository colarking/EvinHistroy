...
public class AmayaEmptyView extends LinearLayout {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        resourceId = a.getResourceId(R.styleable.AmayaEmptyView_emptyImage, R.mipmap.ic_launcher);
        isTextTop = a.getBoolean(R.styleable.AmayaEmptyView_isTextTop, false);
        textColor = a.getColor(R.styleable.AmayaEmptyView_emptyTextColor, getResources().getColor(R.color.white));
