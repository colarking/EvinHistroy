...
import com.evin.R;
import com.evin.fragment.ViewPagerTabScrollViewFragment;
import com.evin.presenter.IAmayaPresenter;
import com.evin.view.SlidingTabLayout;
 ...
 */
public class ViewPagerTabScrollViewActivity extends EvinSwipeActivity implements ObservableScrollViewCallbacks {
    ...
    protected NavigationAdapter newViewPagerAdapter() {
        ...
        titles.add(R.string.title_renwu);
        titles.add(R.string.title_shijian);
        titles.add(R.string.title_zhengzhi);
        titles.add(R.string.title_jingji);
        titles.add(R.string.title_wenzhang);
        return new NavigationAdapter(getSupportFragmentManager(),titles);
    }
    ...
    protected static class NavigationAdapter extends CacheFragmentStatePagerAdapter {
        ...
        public NavigationAdapter(FragmentManager fm,List<Integer> titles) {
            super(fm);
        ...
        public CharSequence getPageTitle(int position) {
            return XApplication.getContext().getString(titles.get(position));
        }
    }
}
